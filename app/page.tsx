      ...
      <footer className="max-w-[1100px] mx-auto px-5 py-8 border-t border-white/10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <img src="/new-csl-logo.png" alt="CSL Logo" className="w-[92px] h-[86px]" />
            <span className="h-8 w-px bg-white/10 hidden md:block" />
            <div className="flex items-center gap-2 text-white/50 text-sm">
              <span>Powered by</span>
              <img src="/robinhood-chain-logo.png" alt="Robinhood Chain" className="h-6 w-6 object-contain rounded" />
              <span className="font-medium text-white/70">Robinhood Chain</span>
            </div>
          </div>
