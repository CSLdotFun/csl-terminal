  ...
  return (
    ...
    >
      ...
      {icon && (
        <div
          style={{
            position: "absolute", right: -20, top: "42%", transform: "translateY(-50%) rotate(-25deg)",
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "32px 36px", height: "100%", boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
        ...
        <img src="/new-csl-logo.png" alt="CSL" style={{ position: "absolute", left: 29, top: 22, height: 136, width: "auto", objectFit: "contain" }} />

        {/* skin name + side badge */}
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 132 }}>
